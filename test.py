...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval-split', type=str, default=None, help='Select the data split to evaluate on. Available splits are train, val and test. Test split valid only for MSN_Easy dataset.')
    ...
    val_loader = torch.utils.data.DataLoader(
        eval_dataset, shuffle=True, batch_size=batch_size, num_workers=num_workers, worker_init_fn=seed_worker, generator=g)
