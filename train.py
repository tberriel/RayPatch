...
if __name__ == '__main__':
    ...
    parser.add_argument('--tune-lr', action='store_true', help='Use PLightning to find lr rate.')
    ...
    val_loader = torch.utils.data.DataLoader(
        ...
        sampler=val_sampler,
        pin_memory=True, worker_init_fn=data.worker_init_fn, persistent_workers=False)
    ...
    callbacks += [ckpt_callback_last,ckpt_callback_backup,ckpt_callback_best, lr_monitor]
